                        ...
                        <?php foreach ($pesanan as $key => $value) { ?>
                          <tr>
                            ...
                            <?php if ($value->status_bayar==1) { ?>
                                <button class="btn btn-sm btn-warning btn-flat" data-toggle="modal" data-target="#cek<?= $value->id_transaksi ?>">Cek Bukti Bayar</button>
                              <a href="<?= base_url('admin/proses/' . $value->id_transaksi) ?>" class="btn btn-sm btn-flat btn-danger">Proses</a>
                                <?php } ?>
                  ...
                  <table class="table">
                        ...
                        <?php foreach ($pesanan_diproses as $key => $value) { ?>
                          <tr>
                            ...
                            <span class="badge badge-danger">Diproses/Dikemas</span>
                            
                                </td>
                            <td>
                            <?php if ($value->status_bayar==1) { ?>
                              <button class="btn btn-sm btn-flat btn-danger" data-toggle="modal" data-target="#kirim<?= $value->id_transaksi ?>"><i class="fa fa-paper-plane"></i> Kirim</button>
                                <?php } ?>
                  ...
                  <table class="table">
                        ...
                        <?php foreach ($pesanan_selesai as $key => $value) { ?>
                          <tr>
                            ...
                            <span class="badge badge-danger">Pesanan Diterima</span>
      ...
      <div class="modal fade" id="kirim<?= $value->id_transaksi ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Pesanan Siap Dikirim?</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <table class="table">
              ...
              <tr>
                ...
                <th>:</th>
                <th><?= $value->tgl_order ?></th>
              </tr>
              <tr>
                <th>Total Bayar</th>
                <th>:</th>
                <th>Rp. <?= number_format($value->grand_total, 0)  ?> + Rp. 15,000 (ongkir)</th>
              </tr>
