<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
              ...
              <div class="card bg-light box-shadow">
                ...
                <div class="col-sm-6">
                <div class="text-left">
                <span class="btn text-muted"><i class="fas fa-dollar"><b> Rp. <?= number_format($value->harga, 0) ?></b></i></span>
                </div>  
                </div>
                <div class="col-sm-6">
                <div class="text-right">
                    <a href="<?= base_url('home/detail_barang/' . $value->id_barang) ?>" class="btn btn-sm btn-secondary">
